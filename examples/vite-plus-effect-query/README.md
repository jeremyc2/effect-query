...
- `effect-query` for query families, query atoms, invalidation, and mutations
- TanStack Router for the page shell

## What it shows

- An overview page backed by a dashboard query atom
- A tasks page where a local atom selects the active task-list query family member
