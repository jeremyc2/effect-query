...
description: Write, review, and improve blog posts for engineering and technical audiences, enforcing high standards of clarity, technical quality, and share-worthiness. Use this skill whenever someone asks to write a blog post, draft a technical article, review blog content, improve a draft, write a product announcement, create an engineering deep-dive, or produce any written content destined for a developer audience. Also trigger when the user mentions "blog post," "blog draft," "write-up," "announcement post," "engineering post," "deep dive," "postmortem," or asks for help with technical writing for developers. Even if the user just says "help me write about [feature/topic]" — if it sounds like it could become a technical blog post, use this skill.
---

# Technical Blog Writing Skill

This skill enforces industry-leading blog writing standards across every post — whether you're helping an engineer write their first blog post or a marketer draft a product announcement.

**The bar:** Every technical blog post should be something a senior engineer would share in their team's Slack, or reference in a technical decision.
...
Use "we" (the team or company) and "you" (the reader). This is a conversation, not a paper.
...
**Bad:** "We're always looking for ways to improve the developer experience. Today, we're thrilled to share some exciting updates to our metrics product that we think you'll love."
...
- "Performance improvements in our platform"
...
| Data / Research      | Original insights from your organization’s or product’s unique data position | Data team, engineering, or research     |
...
1. Never publish without a real person's name on it. No "The Team" bylines.
